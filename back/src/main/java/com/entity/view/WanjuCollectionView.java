...
public class WanjuCollectionView extends WanjuCollectionEntity implements Serializable {
	...
	*/
	...
	private String wanjuCollectionValue;
	...
	public WanjuCollectionView() {

	}

	public WanjuCollectionView(WanjuCollectionEntity wanjuCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, wanjuCollectionEntity);
	...
	* 获取： 类型的值
	*/
	public String getWanjuCollectionValue() {
		return wanjuCollectionValue;
	}
	/**
	* 设置： 类型的值
	*/
	public void setWanjuCollectionValue(String wanjuCollectionValue) {
		this.wanjuCollectionValue = wanjuCollectionValue;
	}
	...
	public String toString() {
		return "WanjuCollectionView{" +
			", wanjuCollectionValue=" + wanjuCollectionValue +
