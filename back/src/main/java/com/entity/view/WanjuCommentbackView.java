...
public class WanjuCommentbackView extends WanjuCommentbackEntity implements Serializable {
	...
	public WanjuCommentbackView() {

	}

	public WanjuCommentbackView(WanjuCommentbackEntity wanjuCommentbackEntity) {
		try {
			BeanUtils.copyProperties(this, wanjuCommentbackEntity);
